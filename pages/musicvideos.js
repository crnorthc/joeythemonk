...
export default function MusicVideos(props) {
	...
	const music_videos = (
		<div className={"grid grid-cols-1 sm:grid-cols-2 myFull:grid-cols-3 " + `${anime ? 'overflow-x-hidden w-screen phone:w-full' : null}`}>
			<div className={"px-2 py-2 " + `${anime ? 'mv-1' : null}`}>
			...
			<div className={"px-2 py-2 " + `${anime ? 'mv-2' : null}`}>
			...
			<div className={"px-2 py-2 " + `${anime ? 'mv-3' : null}`}>
			...
			<div className={"px-2 py-2 " + `${anime ? 'mv-4' : null}`}>
			...
			<div className={"px-2 py-2 " + `${anime ? 'mv-5' : null}`}>
			...
			<div className={"px-2 py-2 " + `${anime ? 'mv-6' : null}`}>
			...
			<div className={"px-2 pt-2 " + `${anime ? 'mv-7' : null}`}>
